...
<body>
	<div style="margin-left: 150px; margin-top: 50px;">
		<form:form id="addform" modelAttribute="companyMonitor"
			action="${ctx}/admin/relation/add" method="post">
			<table style="width:100%" border="0px" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td>
					    <span style="margin-left: 120px;">联&nbsp;系&nbsp;电&nbsp;话
				...
				<tr>
					...
					<td>
						<span style="margin-left: 120px;">监&nbsp;管&nbsp;类&nbsp;型
					    <form:select path="monitorMode" class="select" items="${monitorModeMap}"/>
					    </span>
					</td>
				</tr>
				<tr>
					<td>
				        ...
				        <select class="chzn-select form-inline input-sm" name="areaCode">
				        	...
				        	<c:forEach items="${areaNames}" var="list">
				        		<option value="${list}" <%-- <c:if test="${count.departCountry==list.name}">selected="selected"</c:if> --%> >${list}</option>
				        	</c:forEach>
